...
//upload attendance by admin
    ...
    authorizeRoles("admin"),catchAsyncErrors(async (req,res,next) => {
...
// Get My(User) All Attendance by id  ----------- User
        app.get('/me-attendance',isAuthenticatedUser,catchAsyncErrors(async (req,res,next) => {
...
// Get User Attendance by id and month and year -------------User
        app.get('/me-attendance/:month/:year',isAuthenticatedUser,catchAsyncErrors(async (req,res,next) => {
...
app.get('/me-payroll',isAuthenticatedUser,catchAsyncErrors(async (req,res,next) => {
    ...
    app.get('/me-payroll/:month/:year',isAuthenticatedUser,catchAsyncErrors(async (req,res,next) => {
...
//Get employee Salary Slip by specific month and year ---------admin
    app.get('/salarySlip/:id/:month/:year',isAuthenticatedUser,
    authorizeRoles("admin"),catchAsyncErrors(async (req,res,next) => {
...
app.get('/salarySlip/:id',isAuthenticatedUser,
authorizeRoles("admin"),catchAsyncErrors(async (req,res,next) => {
...
app.get('/me-salarySlips',isAuthenticatedUser,catchAsyncErrors(async (req,res,next) => {
...
app.get('/me-salarySlips/:month/:year',isAuthenticatedUser,catchAsyncErrors(async (req,res,next) => {
